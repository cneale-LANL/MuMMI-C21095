...
# residue numbers in the comment below have not been updated, but throughout the script we do +1 on all Raf residues since 4A is 1 residue longer than 4B
...
rm -f tmpindex.ndx index.ndx
{
  if (( HELIX5ENDNOW != HELIX5ENDORIG )); then
    ...
    echo "r1-${HELIX5ENDNOW} | r189-265 & !aH*"
    echo "r1-${HELIX5ENDNOW} | r189-265 & aHN HA"
    echo "r1-${HELIX5ENDNOW} | r189-265 & rTHR ILE & aHB"
    echo "r CGW & !aH*"
    echo "\"r_1-${HELIX5ENDNOW}_r_189-265_&_!H*\" | \"r_1-${HELIX5ENDNOW}_r_189-265_&_HN_HA\" | \"r_1-${HELIX5ENDNOW}_r_189-265_&_THR_ILE_&_HB\" | r GTP MG | \"CGW_&_!H*\""
    ...
    echo "r1-${HELIX5ENDNOW} | r189-265 & a HN N CA CB C O"
  fi
  if (( HELIX5ENDNOW >= HELIX5ENDORIG )); then
    # the Ras G domain and Raf RBD -- for the original H5 length
    echo "r1-${HELIX5ENDORIG} | r189-265 & !aH*"
    echo "r1-${HELIX5ENDORIG} | r189-265 & aHN HA"
    echo "r1-${HELIX5ENDORIG} | r189-265 & rTHR ILE & aHB"
    echo "r CGW & !aH*"
    echo "\"r_1-${HELIX5ENDORIG}_r_189-265_&_!H*\" | \"r_1-${HELIX5ENDORIG}_r_189-265_&_HN_HA\" | \"r_1-${HELIX5ENDORIG}_r_189-265_&_THR_ILE_&_HB\" | r GTP MG | \"CGW_&_!H*\""
    # a backbone subselection for further enforcement 
    # (don't include a tertiary carbon and all its partners; e.g., exclude HA if have CA, C, N, CB)
    echo "r1-${HELIX5ENDORIG} | r189-265 & a HN N CA CB C O"
  fi
  # the CRD, we will parse it later for the cassette
  echo "r270-321 & !aH*"
  echo "r270-321 & aHN HA"
  echo "r270-321 & rTHR ILE & aHB"
  echo "\"r_270-321_&_!H*\" | \"r_270-321_&_HN_HA\" | \"r_270-321_&_THR_ILE_&_HB\" | r ZN2"
  # a backbone subselection for further enforcement 
  # (don't include a tertiary carbon and all its partners; e.g., exclude HA if have CA, C, N, CB)
  echo "r270-321 & a HN N CA CB C O"
...
groupRasRafNow="r_1-${HELIX5ENDNOW}_r_189-265_AND_notHstar_r_1-${HELIX5ENDNOW}_r_189-265_AND_HN_HA_r_1-${HELIX5ENDNOW}_r_189-265_AND_THR_ILE_AND_HB_GTP_MG_CGW_AND_notHstar"
groupRasRafOrig="r_1-${HELIX5ENDORIG}_r_189-265_AND_notHstar_r_1-${HELIX5ENDORIG}_r_189-265_AND_HN_HA_r_1-${HELIX5ENDORIG}_r_189-265_AND_THR_ILE_AND_HB_GTP_MG_CGW_AND_notHstar"
groupRasRafNowRetain="r_1-${HELIX5ENDNOW}_r_189-265_AND_HN_N_CA_CB_C_O"
groupRasRafOrigRetain="r_1-${HELIX5ENDORIG}_r_189-265_AND_HN_N_CA_CB_C_O"
groupCRD="r_270-321_AND_notHstar_r_270-321_AND_HN_HA_r_270-321_AND_THR_ILE_AND_HB_ZN2"
groupCRDRetain="r_270-321_AND_HN_N_CA_CB_C_O"
